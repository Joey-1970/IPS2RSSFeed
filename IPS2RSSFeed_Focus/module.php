<?
    // Klassendefinition
    class IPS2RSSFeed_Focus extends IPSModule 
    {
	// Überschreibt die interne IPS_Create($id) Funktion
		...
		$this->RegisterTimer("Timer_1", 0, 'IPS2RSSFeedFocus_GetDataUpdate($_IPS["TARGET"]);');

		// Status-Variablen anlegen		
		$this->RegisterVariableString("RSSFeed", "RSS-Feed Focus", "~HTMLBox", 10);
	...
	public function GetDataUpdate()
	{
		if ($this->ReadPropertyBoolean("Active") == true) {
			...
			// Feed einlesen
			if( !$xml = simplexml_load_file('https://rss.focus.de/fol/XML/rss_folnews.xml') ) {
