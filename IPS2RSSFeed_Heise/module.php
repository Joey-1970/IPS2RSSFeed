<?
    // Klassendefinition
    class IPS2RSSFeed_Heise extends IPSModule 
    {
	// Überschreibt die interne IPS_Create($id) Funktion
		...
		$this->RegisterTimer("Timer_1", 0, 'IPS2RSSFeedHeise_GetDataUpdate($_IPS["TARGET"]);');

		// Status-Variablen anlegen		
		$this->RegisterVariableString("RSSFeed", "RSS-Feed Heise", "~HTMLBox", 10);
	...
	public function GetDataUpdate()
	{
		if ($this->ReadPropertyBoolean("Active") == true) {
			...
			// Feed einlesen
			if( !$xml = simplexml_load_file('http://www.heise.de/rss/heise.rdf') ) {
