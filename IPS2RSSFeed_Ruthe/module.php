<?
    // Klassendefinition
    class IPS2RSSFeed_Ruthe extends IPSModule 
    {
	// Überschreibt die interne IPS_Create($id) Funktion
		...
		$this->RegisterTimer("Timer_1", 0, 'IPS2RSSFeedRuthe_GetDataUpdate($_IPS["TARGET"]);');
	...
	public function GetDataUpdate()
	{
		if ($this->ReadPropertyBoolean("Active") == true) {
			...
			// Feed einlesen
			if( !$xml = simplexml_load_file('https://schmacks.de/feeds/ruthe.php?mode=feed') ) {
