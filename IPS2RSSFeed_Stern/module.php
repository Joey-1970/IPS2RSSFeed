<?
    // Klassendefinition
    class IPS2RSSFeed_Stern extends IPSModule 
    {
	// Überschreibt die interne IPS_Create($id) Funktion
		...
		$this->RegisterTimer("Timer_1", 0, 'IPS2RSSFeedStern_GetDataUpdate($_IPS["TARGET"]);');

		// Status-Variablen anlegen		
		$this->RegisterVariableString("RSSFeed", "RSS-Feed Stern", "~HTMLBox", 10);
	...
	public function GetDataUpdate()
	{
		if ($this->ReadPropertyBoolean("Active") == true) {
			...
			// Feed einlesen
			if( !$xml = simplexml_load_file('https://www.stern.de/feed/standard/all/') ) {
